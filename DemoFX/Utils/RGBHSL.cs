...
{
    // I have no freaking idea where this came from, but it's not my style so
    // I got it from somewhere (I don't do inline ifs). Full credit to wherever
    // this came from!
    public static class RGBHSL
    {
            ...
            /// </summary> 
            /// <remarks> 
            /// To reduce Saturation use a number smaller than 1. 
            /// To increase Saturation use a number larger tnan 1 
            /// </remarks> 
            /// <param name="c">The original colour</param> 
            ...
            /// </summary> 
            /// <remarks> 
            /// To reduce Hue use a number smaller than 1.
            /// To increase Hue use a number larger tnan 1 
            /// </remarks> 
            /// <param name="c">The original colour</param> 
